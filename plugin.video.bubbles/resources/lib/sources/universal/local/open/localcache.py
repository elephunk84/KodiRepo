	...
	def sources(self, url, hostDict, hostprDict):
		...
		try:
			...
			for file in files:
				...
				sources.append({'source': '0', 'quality': meta.videoQuality(), 'language' : self.language[0], 'url': file, 'file' : os.path.basename(file), 'local': True, 'direct': True, 'debridonly': False, 'info' : meta.information()})
		except:
			pass

...
class source:
	...
	def sources(self, url, hostDict, hostprDict):
		...
		try:
			...
			results = client.request(query, cookie = cookie)
			...
			for result in results:
				try:
					...
					# Add
					sources.append({'url' : jsonLink, 'premium' : True, 'debridonly' : False, 'direct' : True, 'memberonly' : True, 'source' : 'EasyNews', 'language' : jsonLanguage, 'quality': jsonQuality, 'info' : meta.information(), 'file' : jsonName})

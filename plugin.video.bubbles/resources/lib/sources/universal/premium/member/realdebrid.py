		...
		try:
			...
			for item in items:
				if item['transfer']['progress']['completed']['value'] == 1: # Only finished downloads.
					...
					# Add
					sources.append({'url' : jsonLink, 'premium' : True, 'debridonly' : True, 'direct' : True, 'memberonly' : True, 'source' : 'RealDebrid', 'language' : self.language[0], 'quality':  meta.videoQuality(), 'info' : meta.information(), 'file' : jsonName})

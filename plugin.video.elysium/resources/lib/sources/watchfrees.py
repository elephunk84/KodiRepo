...
class source:
    def __init__(self):
        ...
        self.base_link = 'http://watchfreeseries.net'
		
        self.base_link = control.setting('watchfree_base')
        if self.base_link == '' or self.base_link == None:self.base_link = 'http://watchfreeseries.net'
        ...
        try:
            ...
            for i in links:
                try:
                    ...
                    sources.append({'source': host, 'quality': quality, 'provider': 'Watchfrees', 'url': url, 'direct': False, 'debridonly': False})
                except:
                    pass
